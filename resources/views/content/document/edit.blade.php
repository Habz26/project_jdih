    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <div class="mb-3">
          ...
          <select name="tipe_dokumen" id="tipe_dokumen" class="form-control">
            <option value="Peraturan Perundang-Undangan" {{ old('tipe_dokumen', $document->tipe_dokumen)=='Peraturan Perundang-Undangan' ? 'selected' : '' }}>Peraturan Perundang-Undangan</option>
            <option value="Lainnya" {{ old('tipe_dokumen', $document->tipe_dokumen)=='Lainnya' ? 'selected' : '' }}>Lainnya</option>
          </select>
        </div>
        ...
        <div class="mb-3">
          ...
          <select name="bidang_hukum" id="bidang_hukum" class="form-control">
            <option value="Pidana" {{ old('bidang_hukum', $document->bidang_hukum)=='Pidana' ? 'selected' : '' }}>Pidana</option>
            <option value="Perdata" {{ old('bidang_hukum', $document->bidang_hukum)=='Perdata' ? 'selected' : '' }}>Perdata</option>
          </select>
        </div>
        ...
        <div class="mb-3">
          ...
          <select name="jenis_hukum" id="jenis_hukum" class="form-control">
            <option value="Undang-Undang" {{ old('jenis_hukum', $document->jenis_hukum)=='Undang-Undang' ? 'selected' : '' }}>Undang-Undang</option>
            <option value="Peraturan-Pemerintah" {{ old('jenis_hukum', $document->jenis_hukum)=='Peraturan-Pemerintah' ? 'selected' : '' }}>Peraturan-Pemerintah</option>
          </select>
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" name="singkatan" id="singkatan" class="form-control" value="{{ old('singkatan', $document->singkatan) }}" required>
        </div>

        <div class="mb-3">
          <label for="nomor">Nomor</label>
          <input type="text" name="nomor" id="nomor" class="form-control" value="{{ old('nomor', $document->nomor) }}" required>
        </div>
        ...
        <div class="mb-3">
          ...
          <select name="tahun" id="tahun" class="form-control">
            @for ($i = date('Y'); $i >= 1945; $i--)
              <option value="{{ $i }}" {{ (int)old('tahun', $document->tahun) === $i ? 'selected' : '' }}>{{ $i }}</option>
            @endfor
          </select>
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" name="judul" id="judul" class="form-control" value="{{ old('judul', $document->judul) }}" required>
        </div>

        <div class="mb-3">
          <label for="tempat_penetapan">Tempat Penetapan</label>
          <input type="text" name="tempat_penetapan" id="tempat_penetapan" class="form-control" value="{{ old('tempat_penetapan', $document->tempat_penetapan) }}">
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="mb-3">
          ...
          <input type="date" name="tanggal_penetapan" id="tanggal_penetapan" class="form-control" value="{{ old('tanggal_penetapan', $document->tanggal_penetapan) }}">
        </div>

        <div class="mb-3">
          <label for="tanggal_pengundangan">Tanggal Pengundangan</label>
          <input type="date" name="tanggal_pengundangan" id="tanggal_pengundangan" class="form-control" value="{{ old('tanggal_pengundangan', $document->tanggal_pengundangan) }}">
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" name="lokasi" id="lokasi" class="form-control" value="{{ old('lokasi', $document->lokasi) }}">
        </div>

        <div class="mb-3">
          <label for="urusan_pemerintahan">Urusan Pemerintahan</label>
          <input type="text" name="urusan_pemerintahan" id="urusan_pemerintahan" class="form-control" value="{{ old('urusan_pemerintahan', $document->urusan_pemerintahan) }}">
        </div>

        <div class="mb-3">
          <label for="penandatanganan">Penandatanganan</label>
          <input type="text" name="penandatanganan" id="penandatanganan" class="form-control" value="{{ old('penandatanganan', $document->penandatanganan) }}">
        </div>

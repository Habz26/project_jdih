...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="mb-3">
                @php
                    $filePath = asset('storage/' . $document->pdf_file);
                    $isPdf = \Illuminate\Support\Str::endsWith($document->pdf_file, '.pdf');
                @endphp

                @if($isPdf)
    {{-- Tombol navigasi PDF di atas canvas --}}
    <div class="d-flex align-items-center justify-content-between mb-2">
        ...
        <div>
            <input type="number" id="page-num" class="form-control d-inline-block"
...
@endif
        ...
        <div class="col-md-4">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item"><strong>Tanggal Penetapan:</strong> {{ \Carbon\Carbon::parse($document->tanggal_penetapan)->format('d-m-Y') }}</li>
                <li class="list-group-item"><strong>Tanggal Pengundangan:</strong>  {{ \Carbon\Carbon::parse($document->tanggal_pengundangan)->format('d-m-Y') }}</li>
                ...
                <li class="list-group-item"><strong>Urusan Pemerintahan:</strong> {{ $document->urusan_pemerintahan }}</li>

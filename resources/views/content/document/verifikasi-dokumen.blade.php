    ...
    <div class="row">
        ...
        <div class="col-md-8">
            @php
                ...
                $extension = $document->pdf_file ? \Illuminate\Support\Str::lower(pathinfo($document->pdf_file, PATHINFO_EXTENSION)) : '';
                $isPdf = $extension === 'pdf';
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item"><strong>Keterangan Dokumen:</strong>
                    @if ($document->keteranganDoc)
                        <a href="{{ asset('storage/' . $document->keteranganDoc->pdf_file) }}" target="_blank">{{ $document->keteranganDoc->judul }}</a>
                    @else

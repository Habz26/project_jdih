...
@section('title', 'Peraturan Gubernur - RSKK')
                ...
                <div class="col-lg-9">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-2">
                            ...
                            <li class="breadcrumb-item active">Peraturan Gubernur</li>
                        </ol>
                    </nav>
                    ...
                    <!-- Search -->
                    <form action="{{ route('peraturan-gubernur') }}" method="GET" class="mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table align-middle table-hover">
                                    ...
                                    <tbody>
                                        @forelse ($peraturanGubernur as $dokumen)
                                            <tr>
                                                <td>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="4" class="text-center text-muted py-4">
                                                    Belum ada dokumen keputusan Gubernur yang tersedia.
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
